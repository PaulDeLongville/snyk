...
class WaiverTemplateManager:
    ...
    def _load_default_templates(self) -> List[WaiverTemplate]:
        ...
        return [
            ...
            WaiverTemplate(
                name="requires_social_engineering",
                description="Requires Social Engineering - Unlikely attack vector",
                waiver_type="not-applicable",
                default_days=365,
                justification="This vulnerability requires social engineering and is considered an unlikely attack vector.",
                category="analysis"
            ),
            WaiverTemplate(
                name="prototype_pollution",
                description="Prototype Pollution - Mitigated by architecture",
                waiver_type="not-applicable",
                default_days=365,
                justification="Prototype pollution vulnerability is mitigated by our application architecture and coding practices.",
                category="mitigation"
            )
        ]
...
if __name__ == '__main__':
    ...
    def add_waivers_interactive_with_templates(self, project_ids_file: str):
        ...
        # Get user selection
        selection = input("\nEnter issue numbers (comma-separated) or 